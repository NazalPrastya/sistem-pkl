    ...
    <form action="/dashboard" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tgl_pengajuan')
                is-invalid
            @enderror" id="tgl_pengajuan" name="tgl_pengajuan" value="{{ old('tgl_pengajuan') }}">
            @error('tgl_pengajuan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        {{-- <div class="mb-3">
            ...
            <input type="file" class="form-control @error('pengajuan')
                is-invalid
            @enderror" id="pengajuan" name="pengajuan" value="{{ old('pengajuan') }}">
            @error('pengajuan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input id="pengajuan" type="hidden" name="pengajuan" required value="{{ old('pengajuan') }}" class="@error('pengajuan')
            is-invalid
            @enderror">
